    ...
    <div className={cn("overflow-hidden rounded-md border border-[var(--color-terminal-border)]", className)}>
      ...
      <div className="flex items-center justify-between border-b border-[var(--color-terminal-border)] bg-[var(--color-terminal-surface)] px-3 py-2">
        ...
        <button
          ...
          className="flex items-center gap-1 rounded px-1.5 py-0.5 text-micro text-[var(--color-terminal-dim)] transition-colors hover:text-[var(--color-terminal-text)] focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50"
        >
          {copied ? (
