...
- **`agent/llm/client.py`** — Codex API client (anthropic SDK) with tool-use support
...
- `LITE_MODEL` — Optional, model for simple/quick sub-tasks (default: `Codex-haiku-4-5-20251001`)
